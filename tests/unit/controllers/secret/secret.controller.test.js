...
describe('Secret Controller', () => {
  ...
  const secretId = uuidv4(); // Changed to number to match database expectations
  ...
  describe('createSecret', () => {
    ...
    it('should return 201 and create secret successfully', async () => {
      ...
      const normalizedName = secretData.name.toLowerCase().replace(/\s+/g, '_');
  ...
  describe('updateSecret', () => {
    ...
    it('should return 400 if no valid fields are provided for update', async () => {
      ...
      expect(mockSecret.update).not.toHaveBeenCalled();
    });
  });
